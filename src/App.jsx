        ...
        <div className="container text-center">
          ...
          <div className="steps-grid">
            <div className="step-card" style={{position: 'relative'}}>
              <div className="step-icon" style={{width: '76px', height: '76px', margin: '0 auto 24px', borderRadius: '20px', border: '1px solid rgba(239, 68, 68, 0.3)', background: 'rgba(239, 68, 68, 0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            ...
            <div className="step-card" style={{position: 'relative'}}>
              <div className="step-icon" style={{width: '76px', height: '76px', margin: '0 auto 24px', borderRadius: '20px', border: '1px solid rgba(250, 204, 21, 0.3)', background: 'rgba(250, 204, 21, 0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            ...
            <div className="step-card" style={{position: 'relative'}}>
              <div className="step-icon" style={{width: '76px', height: '76px', margin: '0 auto 24px', borderRadius: '20px', border: '1px solid rgba(34, 197, 94, 0.3)', background: 'rgba(34, 197, 94, 0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
